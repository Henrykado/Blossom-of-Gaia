...
public abstract class MobSpawnerTowerLogic {
        ...
        if (this.isActivated()) {
            ...
            if (this.getSpawnerWorld().isRemote) {
                ...
                this.getSpawnerWorld()
                    .spawnParticle("smoke", d0, d1, d2, 0.0D, 0.0D, 0.0D);
                this.getSpawnerWorld()
                    .spawnParticle("flame", d0, d1, d2, 0.0D, 0.0D, 0.0D);
                ...
                for (int i = 0; i < this.spawnCount; ++i) {
                    ...
                    if (entityliving == null || entityliving.getCanSpawnHere()) {
                        ...
                        if (spawnedCount >= 12) {
                            ...
                            world.setBlock(getSpawnerX(), getSpawnerY(), getSpawnerZ(), Blocks.air);
                        }
                        flag = true;
                    }
                }
    ...
    public Entity func_98265_a(Entity p_98265_1_) {
        if (this.getRandomEntity() != null) {
            ...
            Iterator iterator = this.getRandomEntity().field_98222_b.func_150296_c()
                .iterator();
            ...
            for (Entity entity1 = p_98265_1_; nbttagcompound.hasKey("Riding", 10); nbttagcompound = nbttagcompound2) {
                ...
                if (entity2 != null) {
                    ...
                    Iterator iterator1 = nbttagcompound2.func_150296_c()
                        .iterator();
            ...
            this.getSpawnerWorld()
                .spawnEntityInWorld(p_98265_1_);
        }

        return p_98265_1_;
    }

    public boolean updateSpawnedCount(int p_98268_1_) {
        if (p_98268_1_ == 2 && this.getSpawnerWorld().isRemote) {
            this.spawnedCount++;
            return true;
        } else {
            return false;
    ...
    public void readFromNBT(NBTTagCompound p_98270_1_) {
        ...
        if (p_98270_1_.hasKey("SpawnedCount", 99)) {
            this.spawnedCount = p_98270_1_.getShort("SpawnedCount");
        }
    ...
    public void writeToNBT(NBTTagCompound p_98280_1_) {
        ...
        p_98280_1_.setShort("SpawnedCount", (short) this.spawnedCount);
        ...
        if (this.getRandomEntity() != null
            || this.potentialEntitySpawns != null && this.potentialEntitySpawns.size() > 0) {
    ...
    public Entity func_98281_h() {
        if (this.field_98291_j == null && !entityTypeName.equals("Pig")) {
