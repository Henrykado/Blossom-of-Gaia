...
public class GaiaBlossom {
    ...
    @Mod.Instance(GaiaBlossom.MODID)
    public static GaiaBlossom INSTANCE = new GaiaBlossom();

    @SidedProxy(
        clientSide = "henrykado.gaiablossom.client.ClientProxy",
        serverSide = "henrykado.gaiablossom.CommonProxy")
