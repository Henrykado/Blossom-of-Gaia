...
public enum Mixins {
    ...
    ITEMFRAME_BACKPORT(Phase.EARLY, Side.BOTH, "itemframe.MixinEntityItemFrame"),
    ITEMFRAME_BACKPORT2(Phase.EARLY, Side.CLIENT, "itemframe.MixinRenderItemFrame"),
    ...
    THAUMCRAFT_INFERNAL_STEEL(Phase.LATE, Side.BOTH,
        new TargetedMod[] { TargetedMod.THAUMCRAFT, TargetedMod.RAILCRAFT }, "thaumcraft.MixinTileArcaneFurnace"),

    PMOBS_RAIN_ROCKETCREEPER(Phase.LATE, Side.BOTH, TargetedMod.PRIMITIVE_MOBS, "primitive.MixinRocketCreeper"),
    PMOBS_DIMENSION_BLACKLIST(Phase.LATE, Side.BOTH,
        new TargetedMod[] { TargetedMod.PRIMITIVE_MOBS, TargetedMod.AETHER, TargetedMod.TWILIGHTFOREST },
        "primitive.MixinPMDimensionBlacklist"),
    PMOBS_DIMENSION_BLACKLIST2(Phase.LATE, Side.BOTH,
        new TargetedMod[] { TargetedMod.PRIMITIVE_MOBS, TargetedMod.AETHER, TargetedMod.TWILIGHTFOREST },
    ...
    PMOBS_HIDEACHIEVEMENTS2(Phase.LATE, Side.BOTH, TargetedMod.PRIMITIVE_MOBS, "primitive.MixinPMAchievements"),
